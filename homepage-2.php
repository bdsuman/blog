...
<head>
  <meta charset="utf-8">
  <title>Suman | Personal Blog | Hompage</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 mb-100">
        <article data-file="articles/b.php" data-target="article" class="article-full-width">
          ...
          <div class="post-content">
            ...
            <h4 class="mb-4"><a href="blog-single.php" class="text-dark">Lorem ipsum dolor sit amet, consectetur adipisicing
                elit</a></h4>
            ...
            <a class="btn btn-transparent mb-4" href="blog-single.php">Continue...</a>
          </div>
        </article>
      </div>
      <div class="col-12 mb-100">
        <article data-file="articles/b.php" data-target="article" class="article-full-width article-right">
          <div class="post-image">
