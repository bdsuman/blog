...
<head>
  <meta charset="utf-8">
  <title>Suman | Personal Blog | Home Page</title>
        ...
        <article class="card bg-dark text-center text-white border-0 rounded-0">
          ...
          <div class="card-img-overlay">
            <div class="card-content">
              ...
              <h4 class="card-title mb-4"><a class="text-white" href="blog-single.php">Organize Your Life With 10 Simple rule</a></h4>
              <a class="btn btn-outline-light" href="blog-single.php">read more</a>
            </div>
          </div>
        </article>
      </div>
        ...
        <article class="card bg-dark text-center text-white border-0 rounded-0">
          ...
          <div class="card-img-overlay">
            <div class="card-content">
              ...
              <h4 class="card-title mb-4"><a class="text-white" href="blog-single.php">Organize Your Life With 10
                  Simple rule</a></h4>
              <a class="btn btn-outline-light" href="blog-single.php">read more</a>
            </div>
          </div>
    ...
    <div class="row masonry-container">
      <div class="col-lg-4 col-sm-6 mb-5">
        <article class="text-center">
          ...
          <h4 class="title-border"><a class="text-dark" href="blog-single.php">Charming Evening Field</a></h4>
